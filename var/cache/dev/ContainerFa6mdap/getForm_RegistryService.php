...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AuctionType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AuctionType']) ? $this->services['AppBundle\Form\AuctionType'] : $this->services['AppBundle\Form\AuctionType'] = new \AppBundle\Form\AuctionType()) && false ?: '_'};
}, 'AppBundle\\Form\\BidType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\BidType']) ? $this->services['AppBundle\Form\BidType'] : $this->services['AppBundle\Form\BidType'] = new \AppBundle\Form\BidType()) && false ?: '_'};
