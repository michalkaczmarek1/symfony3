...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'auctions', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'offers', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function addAuction(\AppBundle\Entity\Auction $auction)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAuction', [$auction]);

        return parent::addAuction($auction);
    }
    ...
    public function removeAuction(\AppBundle\Entity\Auction $auction)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAuction', [$auction]);

        return parent::removeAuction($auction);
    }
    ...
    public function getAuctions()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuctions', []);

        return parent::getAuctions();
    }
